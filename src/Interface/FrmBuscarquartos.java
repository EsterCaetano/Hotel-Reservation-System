...
public class FrmBuscarquartos extends javax.swing.JFrame {
    ...
    private void TB_listaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TB_listaMousePressed
      if(evt.getClickCount()==2){
          ...
          FrmReservas.txt_numero.setText(valor);
          this.dispose();
      }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuscarquartos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuscarquartos().setVisible(true);
            }
        });
    }
