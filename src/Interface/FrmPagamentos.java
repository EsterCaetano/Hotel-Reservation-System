...
public class FrmPagamentos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Payments Register");

        jPanel1.setBackground(new java.awt.Color(204, 204, 204));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setText("Payments Register");
        ...
        jLabel4.setText("Voucher Type");

        CB_tipo_comp.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "MBWAY", "TICKET", "NOTA", "Paypal", "FATURA", "OUTRO" }));
        ...
        jLabel8.setText("Voucher number");
        ...
        jLabel15.setText("Issuance date");

        jLabel16.setText("Payday");

        jLabel7.setText("Total Reservation");
        ...
        LB_registros_consumos.setText("Records");
        ...
        jLabel12.setText("List of Payments");
