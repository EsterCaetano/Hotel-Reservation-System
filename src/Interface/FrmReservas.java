...
//        txt_cliente.setEnabled(true);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Booking Registration");
        ...
        btn_pagamentos.setText("Payments");
...
//        }
        ...
        if(acao.equals("salvar")){
            ...
            dts.setIdfuncionario(Integer.parseInt(txt_id_funcionario.getText()));
            if(func.editar(dts)){
                JOptionPane.showMessageDialog(rootPane, "Reservation has been successfully edited!");
                mostrar("");
                desativar();
            }
        }
