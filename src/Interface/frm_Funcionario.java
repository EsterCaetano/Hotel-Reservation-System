...
public class frm_Funcionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CB_tipo1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BI", "Passaporte", "Título de Residencia", "NIF", " ", " " }));
        ...
        CB_estado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Enable", "Desable" }));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txt_login, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGap(149, 149, 149)
        ...
        jLabel4.setText("Employee of  List");
    ...
    private void TB_listaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TB_listaMouseClicked
        ...
        CB_acesso.setSelectedItem(TB_lista.getValueAt(linha, 4).toString());
    ...
    private void btn_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salvarActionPerformed
        ...
        vfuncionarios func = new vfuncionarios();
        ...
        int selecionado = CB_acesso.getSelectedIndex();
        dts.setTipo_documento((String) CB_acesso.getItemAt(selecionado));
        ...
        if(acao.equals("Salvar")){
            if(func.inserir(dts)) {
                JOptionPane.showMessageDialog(rootPane, "O funcionario foi regristado com sucesso!");
    ...
    private void CB_acessoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CB_acessoActionPerformed
        CB_acesso.transferFocus();    //permite o usuario mudar do campo quando preciona atecla enter
