...
public class Fclientes {
    ...
    String[] titulos = {"ID", "Nome", "Nome Pai", "Nome Mãe", "Tipo DOC", "Numero DOC", "Endereço", "Telefone", "Emal", "Código"};
    ...
    sSQL = "select p.id_pessoa,p.nome_pessoa,p.nome_pai,p.nome_mae,p.tipo_documento,p.num_documento,"
                ...
                + buscar + "%' order by id_pessoa desc";    //vai buscar e ordenar de forma decreceste
    try{
        ...
        sSQL2="delete from tb_pessoas where id_pessoa=?";
         ...
         try {
            ...
            PreparedStatement pst2=cn.prepareStatement(sSQL2);
             ...
             pst.setInt(1, dts.getId_pessoa()); //vai pegar o 1º registo da tabela pessoa 
             
            
            pst2.setInt(1, dts.getId_pessoa());    //vai pegar o 1º registo da tabela pessoa
