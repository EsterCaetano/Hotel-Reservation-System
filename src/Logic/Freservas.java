...
public class Freservas {
    ...
    String[] titulos = {"Reservation ID", "Rooms ID", "Number", "Customer ID", "Customer Name", "Employee ID", "Employee", "Booking Type", "Reservation Date", "Date Entry", "Departure Date", "Room Value", "State"};
